  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Input title="Nama" placeholder="Enter Your Email" />
        <Input title="Email" placeholder="Enter Your Password" />
        ...
        <View style={styles.containercheckbox}>
          <View style={{flexDirection: 'row', flex: 1, alignItems: 'center'}}>
            ...
            <Text style={{marginLeft: 8}}>
              Dengan Ini Saya Menyetujui S&K Yang berlaku
            </Text>
          </View>
        </View>
        ...
        <TouchableWithoutFeedback onPress={() => navigation.navigate('Home')}>
          <View style={styles.btnSigin}>
            <Text style={styles.texsigin}>Sign Up</Text>
          </View>
        </TouchableWithoutFeedback>
