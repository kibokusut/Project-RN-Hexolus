...
const DATA = [
  ...
  },
  {
    ...
    StatusDomain: 'Tidak Aktif',
    expired: '15/08/2021',
    aktif: false,
  },
  {
    id: '58694a0f-3da1-471f-bd96-145571e2d9d72',
    domain: 'ayobelajar.com',
    StatusDomain: 'Tidak Aktif',
    expired: '15/08/2021',
    aktif: false,
  },
  {
    id: '58694a0f-3dda1-471f-bd96-145571e2d9d72',
    domain: 'ayobelajar.net',
    StatusDomain: 'Tidak Aktif',
    expired: '15/08/2021',
    aktif: false,
  },
  {
    id: '58694aa0f-3da1-471f-bd96-145571e2d9d72',
    domain: 'ayobelajar.net',
    StatusDomain: 'Tidak Aktif',
    expired: '15/08/2021',
    aktif: false,
...
const Domain = ({navigation}) => {
  ...
  const renderItem = ({item}) => (
    <Item
      title={item.title}
      domain={item.domain}
      StatusDomain={item.StatusDomain}
      aktif={item.aktif}
    ...
    <SafeAreaView style={styles.constainer}>
      <View style={styles.containerheader}>
        <View style={styles.backs}>
          ...
          <Text style={styles.titleheader}>My Domain</Text>
        </View>
